class Segment:
    ...
    def from_dictionary(cls, feature_dictionary):
        ...
        positive = [key for key, value in feature_dictionary.items() if value == "+"]
        negative = [key for key, value in feature_dictionary.items() if value == "-"]
    ...
    def __repr__(self):
        return "<Segment> Positive: {0}, Negative: {1}".format(
