...
#         """
#         return tuple(
#             (frozenset(segment.positive), frozenset(segment.negative))
...
#         given rule."""
#
#         return any(self.index_applicable(i, rule) for i in range(len(self.segments)))
#
...
#             rule["applies"].get("positive", []), rule["applies"].get("negative", [])
#         )
#
