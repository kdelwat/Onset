...
def test_apply_rule():
    ...
    word = Word([Segment(["nasal"], ["syllabic"]), Segment(["syllabic"], ["nasal"])])

    target_word = Word(
        [Segment(["nasal"], ["syllabic"]), Segment(["syllabic", "nasal"], [])]
    )
...
def test_equality():
    word1 = Word([Segment(["nasal"], ["syllabic"]), Segment(["syllabic"], ["nasal"])])

    word2 = Word([Segment(["nasal"], ["syllabic"]), Segment(["syllabic"], ["nasal"])])
...
def test_index_applicable():
    ...
    word = Word(
        [
            Segment(["consonantal", "voice", "labial", "long"], ["syllabic", "stress"]),
            Segment(
                [
                    "syllabic",
                    "sonorant",
            ...
            Segment(["consonantal", "coronal", "anterior"], ["syllabic", "stress"]),
        ]
    )
...
def test_index_applicable_boundaries():
    ...
    word = Word([Segment(["syllabic"], ["nasal"]), Segment(["syllabic"], ["nasal"])])
